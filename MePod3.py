...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.shipCombobox.configure(values=shipList(), font=font)
        ...
        self.billCombobox.configure(values=billList(), font=font)
        ...
        self.DBAddBuuton.configure(takefocus="", font=font)
        ...
        self.DBSpeedEntry.configure(takefocus="", font=font)
        ...
        self.DBSortButton.configure(text='''Sort List''', font=font)
        ...
        self.BOCombobox1.configure(takefocus="", font=font)
        ...
        self.SetLabel4.configure(background="#d9d9d9")
        self.SetLabel4.configure(disabledforeground="#a3a3a3")
        self.SetLabel4.configure(foreground="#000000")
        ...
        self.SetLabel5.configure(background="#d9d9d9")
        self.SetLabel5.configure(disabledforeground="#a3a3a3")
        self.SetLabel5.configure(foreground="#000000")
        ...
        self.ThemeCombobox2.configure(values=themeList)
