...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.PNotebook1.place(relx=0.0, rely=0.0,
        ...
        self.finalListbox.configure(cursor="xterm")
        ...
        self.finalListbox.bind('<Double-3>', deleteFromList)
        self.finalListbox.bind('<BackSpace>', deleteFromList)
        self.finalListbox.bind('<Delete>', deleteFromList)
        self.finalListbox.bind('<Double-1>', editSelection)
        ...
        self.availablePartsListBox.configure(cursor="xterm")
